...
<!--                 <base-dropdown class="nav-item" menu-classes="dropdown-menu-xl">
                    <a slot="title" href="#" class="nav-link" data-toggle="dropdown" role="button">
                        ...
                        <span class="nav-link-inner--text">Servidores Minecraft Modded</span>
                    </a>
...
SS                        <span class="nav-link-inner--text">Examples</span>
                    </a>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="http://discord.miauhalla.com" target="_blank" rel="noopener"
                       data-toggle="tooltip" title="Unete a nuestro Discord">
...
<!--                 <li class="nav-item">
                ...
                <li class="nav-item d-none d-lg-block ml-lg-4">
                    <a href="http://tienda.miauhalla.com" rel="noopener"
                       class="btn btn-neutral btn-icon">
                <span class="btn-inner--icon">
                  <i class="ni ni-shop mr-2"></i>
                </span>
                        <span class="nav-link-inner--text">Visita nuestra tienda</span>
                    </a>
                </li>
            </ul>
        </base-nav>
